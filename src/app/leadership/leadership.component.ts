...
export class LeadershipComponent implements OnInit {
  readonly infoCardDetails: InfoCardDetails[] = [
    ...
    },
    {
      ...
      dates: 'Jan 2020 - Current',
      descriptionPoints: [
        'Responsible for the club budget (~$900) and sent proceeds from fundraisers to UNICEF',
        'Communicated with local businesses for fundraisers and for organizing volunteering events',
        'Worked together with the officer team of 6 to research and present current world issues to 200+ club members',
      ],
